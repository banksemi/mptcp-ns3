...
{
	std::string filename = "../ns-3.28/src/mmwave/model/BeamFormingMatrix/SmallScaleFading.txt";
...
{
	std::string filename = "../ns-3.28/src/mmwave/model/BeamFormingMatrix/TxAntenna.txt";
...
{
	std::string filename = "../ns-3.28/src/mmwave/model/BeamFormingMatrix/RxAntenna.txt";
...
{
	std::string filename = "../ns-3.28/src/mmwave/model/BeamFormingMatrix/TxSpatialSigniture.txt";
...
{
	std::string strFilename = "../ns-3.28/src/mmwave/model/BeamFormingMatrix/RxSpatialSigniture.txt";
